...
Security
Insights
action-group/Task/fqkk.js /
@tsuyoshi727
tsuyoshi727 Update fqkk.js
Latest commit 1cfd0c4 11 days ago
 History
 2 contributors
@iparwita@tsuyoshi727
328 lines (269 sloc)  17.4 KB
...
let fqkk = $.toObj(process.env.FQKK || '[]', [])
let fqkey = ''
let fqkkxh = ($.getval('fqkkxh') || '20');  // 此处修改循环次数，默认一百
let fqtx = ($.getval('fqtx') || '150');  // 此处修改提现金额，0.1元等于10，默认为提现一元，也就是100
let max = 120
let min = 37
